...
exports.getStudents = (req, res) => {
    db.query('SELECT * FROM demo_dar', (err, results) => {
        if (err) {
...
exports.addStudent = (req, res) => {
    ...
    const query = 'INSERT INTO demo_dar (id, name, dept) VALUES (?, ?, ?)';
...
exports.updateStudent = (req, res) => {
    ...
    const query = 'UPDATE demo_dar SET name = ?, dept = ? WHERE id = ?';
...
exports.deleteStudent = (req, res) => {
    const { id } = req.params;
    const query = 'DELETE FROM demo_dar WHERE id = ?';
